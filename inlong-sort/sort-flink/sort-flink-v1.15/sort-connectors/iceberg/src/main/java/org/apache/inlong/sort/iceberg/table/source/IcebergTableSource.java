...
public class IcebergTableSource
    ...
    private DataStream<RowData> createDataStream(StreamExecutionEnvironment execEnv) {
        log.info("start to create normal data stream");
    ...
    private DataStreamSource<RowData> createFLIP27Stream(StreamExecutionEnvironment env) {
        log.info("start to create flip 27 data stream");
    ...
    public ScanRuntimeProvider getScanRuntimeProvider(ScanContext runtimeProviderContext) {
        return new DataStreamScanProvider() {
            ...
            public DataStream<RowData> produceDataStream(
                ...
                log.info("readableConfig={}", readableConfig);
                log.info("flip27={}", readableConfig.get(FlinkConfigOptions.TABLE_EXEC_ICEBERG_USE_FLIP27_SOURCE));
