...
public class StreamingMonitorFunction extends RichSourceFunction<FlinkInputSplit>
    ...
    private transient InlongIcebergSourceReaderMetrics metrics;

    private transient MetricOption metricOption;

    public StreamingMonitorFunction(TableLoader tableLoader, ScanContext scanContext, MetricOption metricOption) {
    ...
    public void open(Configuration parameters) throws Exception {
        ...
        if (metricOption != null) {
            this.metrics = new InlongIcebergSourceReaderMetrics(runtimeContext.getMetricGroup(), table.name());
