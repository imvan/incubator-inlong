...
public class FlinkSource {
    ...
    public static class Builder {
        ...
        public void buildMetricOption() {
            if (StringUtils.isNullOrWhitespaceOnly(inlongAuditAddress)) {
                inlongAuditAddress = readableConfig.get(INLONG_AUDIT);
            }
            if (StringUtils.isNullOrWhitespaceOnly(inlongAuditKeys)) {
                inlongAuditKeys = readableConfig.get(AUDIT_KEYS);
            }
            if (StringUtils.isNullOrWhitespaceOnly(inlongMetrics)) {
                inlongMetrics = readableConfig.get(INLONG_METRIC);
            }
        ...
        public DataStream<RowData> build() {
            ...
            if (!context.isStreaming()) {
                ...
                StreamingMonitorFunction function = new StreamingMonitorFunction(tableLoader, context, metricOption);
