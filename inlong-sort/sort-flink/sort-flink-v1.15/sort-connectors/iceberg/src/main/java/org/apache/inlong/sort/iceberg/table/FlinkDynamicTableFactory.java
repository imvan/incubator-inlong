...
public class FlinkDynamicTableFactory implements DynamicTableSinkFactory, DynamicTableSourceFactory {
    ...
    public FlinkDynamicTableFactory() {
        log.info("create flink dynamic table factory with no argument");
        this.catalog = null;
    }

    public FlinkDynamicTableFactory(FlinkCatalog catalog) {
        log.info("create flink dynamic table factory with catalog={}", catalog);
    ...
    public DynamicTableSink createDynamicTableSink(Context context) {
        ...
        log.info("start to create dynamic table sink");
